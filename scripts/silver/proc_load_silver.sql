...
Script Purpose:
	This stored procedure performs ETL process to populate the 
...
BEGIN
	BEGIN TRY
		...
		PRINT '>> Transforming & Inserting data into silver.crm_cust_info';
		...
		PRINT '>> Transforming & Inserting data into silver.crm_prd_info';
		...
		PRINT '>> Transforming & Inserting data into silver.crm_sales_details';
		...
		PRINT '>> Transforming & Inserting data into silver.erp_cust_az12';
		...
		PRINT '>> Transforming & Inserting data into silver.erp_loc_a101';
		...
		PRINT '>> Transforming & Inserting data into silver.erp_px_cat_g1v2';
	...
	BEGIN CATCH
		...
		PRINT 'AN ERROR OCURRED WHEN TRYING TO LOAD SILVER LAYER';
